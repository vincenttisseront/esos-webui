/**
 * GET /api/raid/block-devices — Block devices avec usage détecté (SDD v3.12 §8.1).
 */
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      ...
      statusMessage: err.statusMessage ?? err.message ?? 'Erreur block devices',
    })
  }
})
